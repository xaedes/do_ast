...
VISITABLE_STRUCT(Nodes, items, neighbors, neighbors_packed, traverse_preorder, traverse_postorder, sorted_preorder, sorted_postorder, depth, num_children);
VISITABLE_STRUCT(Nodes::Items,             items);
VISITABLE_STRUCT(Nodes::Neighbors,         up, down, prev, next);
VISITABLE_STRUCT(Nodes::NeighborsPacked,   neighbors);
VISITABLE_STRUCT(Nodes::TraversePreorder,  next, skip);
VISITABLE_STRUCT(Nodes::TraversePostorder, next);
VISITABLE_STRUCT(Nodes::SortedPreorder,    indices);
VISITABLE_STRUCT(Nodes::SortedPostorder,   indices);
VISITABLE_STRUCT(Nodes::Depth,             depth);
VISITABLE_STRUCT(Nodes::NumChildren,       num_children);
